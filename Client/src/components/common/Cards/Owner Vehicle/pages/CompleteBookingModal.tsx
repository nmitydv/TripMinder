...
function CompleteBookingModal(props) {
    ...
    const [totalAmount, setTotalAmount] = useState(totalKm * bookingPrice);
    ...
    useEffect(() => {
        setTotalAmount(totalKm * bookingPrice);
    }, [totalKm, bookingPrice]);

    const handleBookingRequest = async () => {
        // await createBookSend(bookingData);
        Swal.fire({
            title: t('completebookingmodal.title'),
            // 'Are you sure?',
            text: t('completebookingmodal.text'),
            // 'You want to complete this booking request.',
            icon: 'warning',
            iconColor: '#ED6C02',
            showCancelButton: true,
            cancelButtonText: t('completebookingmodal.cancel'),
            //  'Cancel',
            cancelButtonColor: '#D5D7E3',
            confirmButtonColor: '#3085d6',
            confirmButtonText:  t('completebookingmodal.yes'),
            // 'Yes',
            showClass: {
                popup: `
              animate__animated
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    if (resp?.data?.statusCode === 200) {
                        ...
                        Swal.fire({
                            title: t('completebookingmodal.titlesuccess'),
                            // 'Success',
                            text:  t('completebookingmodal.bookingsuccessfull'),
                            confirmButtonText:t('completebookingmodal.okkk'),
                    ...
                    if (resp?.error?.data?.statusCode === 400) {
                        ...
                        Swal.fire({
                            ...
                            title: t('completebookingmodal.invaliddata'),
                            // 'Invalid Data',

                            text: t('completebookingmodal.validdata'),
                    ...
                    setShowPageLoader(false);
                    Swal.fire({
                        title: t('completebookingmodal.errortitle'),
                        // 'Error',
                        text:  t('completebookingmodal.errorcomplete'),
                        // 'Error To Complete Booking',
                        icon: 'error',
                        showClass: {
                            popup: `
                          animate__animated
                ...
                <Modal.Body>
                    ...
                    >
                        ...
                        <div className="col d-flex flex-column justify-content-lg-start justify-content-center mt-4 position-relative">
                            ...
                            />
                            <label htmlFor="totalAmount" className="lable__box">
