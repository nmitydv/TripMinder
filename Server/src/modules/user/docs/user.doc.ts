...
export function FindUserByIdDoc(): MethodDecorator {
    return applyDecorators(
        Doc<UserGetSerialization>('user.findById', {
            auth: {
                jwtAccessToken: true,
            },
            response: {
...
export function UserUpdateByIdDoc(): MethodDecorator {
    return applyDecorators(
        Doc<UserGetSerialization>('user.update', {
            auth: {
                jwtAccessToken: true,
            },
            response: {
...
export function UserNotificationSaveDoc(): MethodDecorator {
    return applyDecorators(
        Doc<UserGetSerialization>('user.save', {
            auth: {
                jwtAccessToken: true,
            },
            response: {
