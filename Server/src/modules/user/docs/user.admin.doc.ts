...
export function UserListDoc(): MethodDecorator {
    return applyDecorators(
        DocPaging<UserListSerialization>('user.list', {
            ...
            request: {
                queries: [...UserDocQueryByRole,...UserDocQueryIsActive],
            },
            response: {
...
export function vehicleIsApproveDoc(): MethodDecorator {
    return applyDecorators(
        Doc<void>('vehicle.isApprove', {
            auth: {
                jwtAccessToken: true,
            },
            response: {
...
export function UserByIdDoc(): MethodDecorator {
    return applyDecorators(
        Doc<UserGetSerialization>('user.get', {
            auth: {
                jwtAccessToken: true,
...
export function AdminByIdDoc(): MethodDecorator {
    return applyDecorators(
        Doc<UserGetSerialization>('admin.get', {
            auth: {
                jwtAccessToken: true,
            },
            response: {
...
export function UserByRoleDoc(): MethodDecorator {
    return applyDecorators(
        DocPaging<UserListSerialization>('user.list', {
            auth: {
                jwtAccessToken: true,
